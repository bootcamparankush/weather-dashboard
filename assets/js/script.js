//javascript showing the usage of API key from OpenWeather map
localStorage.clear();
...
function findCity() {
    ...
    var apiURL = "https://api.openweathermap.org/data/2.5/weather?q=" + cityName + "&units=imperial&appid=f8739324a545617a82e155aff73f6015";
    ...
    fetch(apiURL).then(function (response) {
        if (response.ok) {
            response.json().then(function (data) {
                ...
                apiURL = "https://api.openweathermap.org/data/2.5/weather?lat=" + lat + "&lon=" + lon + "&exclude=minutely,hourly&units=imperial&appid=f8739324a545617a82e155aff73f6015";
...
// This function gets the information for a city already in the list.
function getListCity(coordinates) {
    apiURL = "https://api.openweathermap.org/data/2.5/weather?lat=" + coordinates[0] + "&lon=" + coordinates[1] + "&exclude=minutely,hourly&units=imperial&appid=f8739324a545617a82e155aff73f6015";
...
function getCurrentWeather(data) {
    ...
    // $("#currentIcon")[0].src = "https://api.openweathermap.org/img/wn/" + data.current.weather[0].icon + "@2x.png";
    $("#currentIcon")[0].src = "https://api.openweathermap.org/data/2.5/weather?icon" + data.current.weather[0].icon + "@2x.png";
...
//this function get future next 5 days weather data
